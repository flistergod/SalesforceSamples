...
import { OMNIDEF } from './quoteAmend_Volume_SummaryEnglish_def.js';
import tmpl from './quoteAmend_Volume_SummaryEnglish.html';
import tmpl_nds from './quoteAmend_Volume_SummaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteAmend_Volume_SummaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
