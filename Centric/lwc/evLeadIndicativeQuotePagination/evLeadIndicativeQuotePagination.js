...
export default class Paginator extends LightningElement {
    ...
    setRecordsToDisplay(){
        if(this.totalRecords > 0){
            ...
            //console.log("evLeadIndicativeQuotePagination setRecordsToDisplay", JSON.parse(JSON.stringify(this.recordsToDisplay)));
    ...
    @api get recordsToShow(){
        return this.records;
    }

    set recordsToShow(value){
    ...
    /*
    @api get totalRecordsToShow(){
        return this.totalRecords;
    }

    set totalRecordsToShow(value){
