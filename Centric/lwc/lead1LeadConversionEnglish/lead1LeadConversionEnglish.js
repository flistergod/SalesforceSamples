...
import { OMNIDEF } from './lead1LeadConversionEnglish_def.js';
import tmpl from './lead1LeadConversionEnglish.html';
import tmpl_nds from './lead1LeadConversionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lead1LeadConversionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
