...
import { OMNIDEF } from './leadBroker1LeadConversionEnglish_def.js';
import tmpl from './leadBroker1LeadConversionEnglish.html';
import tmpl_nds from './leadBroker1LeadConversionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class leadBroker1LeadConversionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
