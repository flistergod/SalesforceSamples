import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/utility";
          ...
          export default class cfSWAN_Electricity_Monthly_Volume_Summary extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-a478E000000EfPrQAK"
                );
                loadStyle(this, "/servlet/servlet.FileDownload?file=00P8E00000BK32dUAD").then(() =>{
                  //Loading Custom CSS.
                })
