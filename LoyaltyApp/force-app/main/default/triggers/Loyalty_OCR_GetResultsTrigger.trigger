...
**/
trigger Loyalty_OCR_GetResultsTrigger  on Account (after update) {
  ...
  while(System.Now()<start.addseconds(2)){}
    ...
    Loyalty_I_OCR_Handler ocrGet=new Loyalty_cls_OCR_Handler_Azure_GET(operationId_param, recordId_param);
